    ...
    <>
      ...
      <div className="py-2 md:p-2 ">
        ...
        <div className="  rounded-lg overflow-hidden">
          ...
          <Carousel>
            <CarouselItem>
              <div className="h-[200px] sm:h-[350px] md:h-[460px] w-full relative">
                {/* <Image 
            width={1800}
            height={400}
            className='' alt='Matka juju banner' src="/images/banner/matkajuju.jpg" /> */}

                <Image fill sizes="(max-width: 768px) 100vw, 33vw" className='w-full h-full object-cover' alt='Matka juju banner' 
            ...
            <CarouselItem>
              <div className="h-[200px] sm:h-[350px] md:h-[460px] w-full relative">
                ...
                <Image
                  ...
                  className='object-cover' alt='Matka juju banner'
                   src="/images/banner/matkajuju.png"
      ...
      <main className="  mx-auto max-w-screen-xl pt-8">
        <div className="about md:px-16 px-4 md:pt-8">
          <h1 className='text-3xl md:text-4xl text-center  font-bold mb-8 text-yellow-600 uppercase'>Juju Dhau: A Traditional Delight</h1>
          <p className=''>
        ...
        <div className="categories text-center py-8 md:py-12 lg:py-16">
          <div className="mb-6">
            ...
            <h2 className={' text-center font-bold text-3xl md:text-4xl md:mb-2 text-yellow-600'}>MATKA JUJU DHAU</h2>
